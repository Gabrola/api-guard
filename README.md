...
Now we need to get the package's config and migrations files and run the the api-guard migration (make sure you have your database configuration set up correctly):

    $ php artisan vendor:publish --tag=apiguard
    $ php artisan migrate
